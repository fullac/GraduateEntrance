...
## 说在前面
<mark>刷题中C和C++的题混合在一起，下文的知识点也是杂糅的，请注意！C++已标注出。<\mark>
...
14. 结构体中不允许直接定义本结构体类型的变量，但可以定义指向本结构体类型的指针。
15. 从C源代码到可执行文件的四个过程：预处理、编译、汇编、链接：Linux下每个过程对应的生成文件扩展名为：.c -> .i -> .s -> .o -> .exe
